{foreach from=$Pages item=postions name="pagingLoop" key=page}
	<div>
		<img src="{$smarty.session.Shopware.pluginPath}/media/image/pdf_logo.jpg" />
	</div>
	<div id="header">
		<div id="head_left">
	...
	{if $smarty.foreach.pagingLoop.last}
		{block name="document_index_amount"}
		 	<div id="amount">
			  ...
			  <img src="{$smarty.session.Shopware.pluginPath}/media/image/owner_signature.jpg" class="signpic" />
			</div>
		{/block}
