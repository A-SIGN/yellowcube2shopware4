...
Ext.define('Shopware.apps.AsignYellowcube.controller.Product', {
    ...
    onSelectionChange: function(sm, selections) {   
        if (selections[0]) {
            ...
            record = selections[0],
            response = Ext.decode(record.get('ycResponse')),
            ...
            me.displaySidebarFields(finaltext, articleId); // show/hide fields
        }
    },
    ...
    * @return void
    */
    displaySidebarFields: function(finaltext, articleId) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {              
                ...
                if(response.success) {
                    ...
                    me.displaySidebarFields(resultString, rowid); // show/hide fields
