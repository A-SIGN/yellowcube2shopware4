...
{      
	...
	public function getInventory()
	{
        ...
        try{           
            ...
            $this->oLogs->saveLogsData('Inventory', $soapex);
    ...
    {   
        ...
        try{            
            ...
            $this->oLogs->saveLogsData('Article', $soapex);
            throw new Exception($soapex->getMessage());
            return(array(
                            'success' => false,
                            'message' => $soapex->getMessage()
    ...
    public function getYCGeneralDataStatus($itemId, $sType)
    {
        ...
        try{              
            ...
            $this->oLogs->saveLogsData($sType, $soapex);            
            return(array(
                            'success' => false,
                            'message' => $soapex->getMessage()
                        ));           
    ...
    protected function getYCFormattedArticleData($aArticle, $sFlag)
    {
        ...
        $aYCParams         = $this->getYCParams($aArticle['articleID']);
    ...
    public function createYCCustomerOrder($aOrders, $isReturn = false)
    {
        ...
        if (is_array($oRequestData) && $oRequestData['success'] === false) {
            ...
            try{
                ...
                $this->oLogs->saveLogsData('Orders', $soapex);            
                return(array(
                                'success' => false,
                                'message' => $soapex->getMessage()
                            ));
    ...
    public function getYCFormattedOrderData($aOrder, $isReturn = false)
    {
        ...
        if (is_array($sZipCode) && $sZipCode['success'] === false) {
            ...
            foreach ($oOrderArticles as $key=>$article) {
                ...
                $oObject->Order->OrderPositions->Position->ShortDescription = $article['name'];
        ...
        try {
            ...
            if (in_array($countryISO, $myArray)) {
                ...
                if (strlen($zipValue) != $maxChars) {
                    $message = $this->getSnippetValue('backend/asignyellowcube/view/main', 'yellowcube/zip/message/nomatch');
                    $this->oLogs->saveLogsData('ZIP_ERROR', $message, true);
                    return(array(
                            'success' => false,                            
                            'zcode'   => -2,
                            'message' => $message
            ...
            $this->oLogs->saveLogsData('ZIP_ERROR', $soapex);
            return(array(
                        'success' => false,
